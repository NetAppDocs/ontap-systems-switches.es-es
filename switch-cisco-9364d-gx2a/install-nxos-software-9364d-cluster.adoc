...
* Complete el procedimiento enlink:install-nxos-overview-9364d-cluster.html["Prepárese para instalar NX-OS y RCF."] .
...
.¿Que sigue?
Después de haber instalado o actualizado el software NX-OS, puedes link:install-upgrade-rcf-overview-cluster-9364d.html["instalar o actualizar el archivo de configuración de referencia (RCF)"].
