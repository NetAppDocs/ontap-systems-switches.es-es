...
.¿Que sigue?
Después de haber instalado o actualizado el software NX-OS, ustedlink:install-upgrade-rcf-overview-cluster.html["instalar o actualizar el archivo de configuración de referencia (RCF)"] .
