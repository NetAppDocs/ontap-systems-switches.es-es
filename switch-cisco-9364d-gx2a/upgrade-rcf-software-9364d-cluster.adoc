...
.. Para NX-OS 10.2 y versiones más recientes, utilice el `show diff running-config` comando para comparar con el archivo RCF guardado en el bootflash.  De lo contrario, utilice una herramienta de comparación/diferenciación de terceros.
