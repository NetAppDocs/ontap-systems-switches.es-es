...
summary: 'Siga estos pasos para reemplazar un conmutador Nexus 9364D-GX2A defectuoso en una red de clúster. Este es un procedimiento no disruptivo (NDU).' 
---
= Reemplaza un switch - Cisco Nexus 9364D-GX2A
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
** La personalización inicial del switch está completa, como se detalla en link:configure-complete-initial-setup-9364d.html["Completa la configuración inicial del conmutador"].
+
...
----
====
. Activa todos los puertos en el switch newcs2.
+
.Mostrar ejemplo
[%collapsible]
====
