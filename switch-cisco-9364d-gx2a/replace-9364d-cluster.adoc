...
** La personalización inicial del conmutador está completa, como se detalla enlink:setup-switch-9364d-cluster.html["Configurar el conmutador de clúster 9364D-GX2A"] .
+
