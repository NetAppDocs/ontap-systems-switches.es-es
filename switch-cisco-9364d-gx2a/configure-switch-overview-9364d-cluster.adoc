...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-1.png["1"]link:configure-setup-ports-9364d.html["Revisar los detalles del puerto del conmutador"]
