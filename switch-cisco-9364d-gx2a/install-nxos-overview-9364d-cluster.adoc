...
summary: Prepárese para instalar el software NX-OS y RCF. 
---
...
.¿Que sigue?
Después de haberte preparado para instalar el software NX-OS y RCF, link:install-nxos-software-9364d-cluster.html["instalar o actualizar el software NX-OS"].
