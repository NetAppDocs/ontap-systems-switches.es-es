...
* link:required-documentation-9364d-cluster.html["Documentación necesaria sobre el switch y ONTAP"] .
...
.El futuro
Después de haber configurado sus conmutadores,link:install-nxos-overview-9364d-cluster.html["Prepárese para instalar NX-OS y RCF"] .
