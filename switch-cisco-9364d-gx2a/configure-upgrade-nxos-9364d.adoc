...
summary: Actualizas el NX-OS en tus switches Cisco Nexus 9364D-GX2A para admitir nuevo hardware o una nueva versión de ONTAP en tu sistema AFX 1K o AFX 2K. 
---
= Actualiza el NX-OS - Cisco Nexus 9364D-GX2A
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Actualizas el NX-OS en tus switches Cisco Nexus 9364D-GX2A para admitir nuevo hardware o una nueva versión de ONTAP en tu sistema AFX 1K o AFX 2K.
...
.¿Que sigue?
Después de que hayas actualizado el NX-OS en tus conmutadores, actualiza el RCF comenzando con el link:configure-install-upgrade-rcf-overview-9364d.html["Instalar o actualizar la descripción general de RCF"].
