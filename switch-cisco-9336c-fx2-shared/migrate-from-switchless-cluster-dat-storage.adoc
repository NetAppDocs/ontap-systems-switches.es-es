...
La mayoría de los sistemas requieren dos puertos de red de clúster dedicados en cada controladora. Consulte https://["Switches Ethernet de Cisco"] si quiere más información.
...
** La solución de NetApp https://["Hardware Universe"] contiene más información sobre el cableado.
...
* Los puertos de clúster que se utilizan en este procedimiento son _e3a_ y _e3b_, como se indica en la controladora AFF A400. La https://["Hardware Universe"] contiene la información más reciente acerca de los puertos del clúster reales para las plataformas.
