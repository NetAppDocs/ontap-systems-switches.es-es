...
La mayoría de los sistemas requieren dos puertos de red de clúster dedicados en cada controlador. Consulta link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Switches Ethernet de Cisco"^] para más información.
...
** El link:https://hwu.netapp.com["Hardware Universe"^] contiene más información sobre el cableado.
...
* Los puertos de clúster utilizados en este procedimiento son _e3a_ y _e3b_, según el controlador AFF A400. El link:https://hwu.netapp.com["Hardware Universe"^] contiene la información más reciente sobre los puertos de clúster reales para tus plataformas.
