...
----
====
. Comprueba el estado administrativo u operativo de cada interfaz de clúster y de cada puerto de almacenamiento de nodo y puerto de estantería de almacenamiento.
+
