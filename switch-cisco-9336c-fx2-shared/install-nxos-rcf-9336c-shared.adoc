...
[role="lead"]
Puede instalar el archivo de configuración de referencia (RCF) después de configurar el conmutador Nexus 9336C-FX2 por primera vez.
...
* Se conectan las conexiones de enlace entre switches (ISL) entre los switches.
...
. Registre cualquier adición personalizada entre la actual `running-config` archivo y el archivo RCF en uso.
