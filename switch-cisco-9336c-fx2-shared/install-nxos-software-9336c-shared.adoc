...
----
====
. Comprueba el estado administrativo y operativo de cada puerto de clúster, puerto de almacenamiento de nodo y puerto de estantería de almacenamiento.
+
...
----
====
. Verifica el estado de todos los puertos del clúster.
+
