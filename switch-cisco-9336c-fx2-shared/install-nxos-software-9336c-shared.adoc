...
* Guías de software y actualización adecuadas disponibles en el sitio web de Cisco para los procedimientos de actualización y degradación de switches de Cisco. Consulte https://["Switches Cisco Nexus serie 9000"^].
