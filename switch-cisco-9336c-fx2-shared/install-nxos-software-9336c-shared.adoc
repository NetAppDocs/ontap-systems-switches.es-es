...
[role="lead"]
Siga este procedimiento para instalar el software NX-OS en el switch compartido Nexus 9336C-FX2.
...
.¿Que sigue?
Una vez instalado el software NX-OS, podrá link:install-nxos-rcf-9336c-shared.html["instalar el RCF"].
