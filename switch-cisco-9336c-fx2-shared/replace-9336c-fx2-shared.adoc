...
. [[step15]]habilite la función de recopilación de registros del monitor de estado del switch Ethernet para recopilar archivos de registro relacionados con el conmutador, utilizando los siguientes comandos:
+
...
. [[step16]]mueva los puertos de almacenamiento del interruptor sh2 antiguo al nuevo interruptor news2.
...
. [[step19]]Compruebe que las estanterías estén cableadas correctamente:
+
...
. [[step20]]retire el interruptor sh2 antiguo.
