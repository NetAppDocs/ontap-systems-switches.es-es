...
. Consulta link:cabling-considerations-9336c-shared.html["Revisar las consideraciones de cableado y configuración"] para ver detalles de cualquier otro cambio necesario.
...
----
====
. Repite los pasos 1 a 21 en el switch cs2.
