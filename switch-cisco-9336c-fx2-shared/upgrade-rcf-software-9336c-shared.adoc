...
.. Para NX-OS 10,2 y posterior, utilice el `show diff running-config` comando para comparar con el archivo RCF guardado en el bootflash. De lo contrario, utilice una herramienta de comparación o de diferencia de terceros.
