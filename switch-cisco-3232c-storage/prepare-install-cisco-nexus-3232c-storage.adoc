...
summary: El software Cisco NX-OS y los archivos de configuración de referencia RCF deben instalarse en los switches de almacenamiento Cisco Nexus 3232C. 
---
