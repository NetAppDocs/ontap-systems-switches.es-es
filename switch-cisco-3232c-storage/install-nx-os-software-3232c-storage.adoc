...
.Antes de empezar
Verifica que tienes lo siguiente: * Una copia de seguridad actual de la configuración del switch. * Un clúster en pleno funcionamiento (sin errores en los registros ni problemas similares). * link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["página del switch Ethernet de Cisco"^]. Consulta la tabla de compatibilidad de switches para las versiones compatibles de ONTAP y NX-OS. * link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Switches Cisco Nexus serie 3000"^]. Consulta las guías de software y actualización adecuadas disponibles en el sitio web de Cisco para la documentación completa sobre los procedimientos de actualización y downgrade de switches Cisco.
...
----
====
. Repita los pasos 6 a 14 en el interruptor cs1.
