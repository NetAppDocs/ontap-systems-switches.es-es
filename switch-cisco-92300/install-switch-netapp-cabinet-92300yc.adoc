...
.Antes de empezar
* Los requisitos de preparación inicial, el contenido del kit y las precauciones de seguridad en ellink:http://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexu9000/hw/installation/guide/b_n3000_hardware_install_guide.html["Guía de instalación de hardware de Cisco Nexus serie 9000"^] .
