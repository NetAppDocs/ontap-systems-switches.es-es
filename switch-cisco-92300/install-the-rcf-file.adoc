...
[role="lead"]
Siga este procedimiento para instalar el RCF después de configurar por primera vez el interruptor Nexus 92300YC. También puede utilizar este procedimiento para actualizar la versión de RCF.
...
.El futuro
link:setup-install-cshm-file.html["Instale el archivo de configuración del Monitor de estado del conmutador de clúster (CSHM)"].
