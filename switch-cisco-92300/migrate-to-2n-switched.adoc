...
NOTE: Después de que termine tu migración, puede que necesites instalar el archivo de configuración necesario para admitir Cluster Switch Health Monitor (CSHM) para los switches de clúster 92300YC. Consulta link:../switch-cshm/cshm-overview.html["Monitoreo de salud del switch (CSHM)"].
