...
+
https://hwu.netapp.com["Hardware Universe"^] contiene la información más reciente acerca de los puertos del clúster reales para las plataformas.
...
+
La https://hwu.netapp.com/SWITCH/INDEX["_Hardware Universe - Switches_"^] contiene más información sobre el cableado.
...
--
====
. [[step8]] Si suprimió la creación automática de casos, vuelva a activarlo invocando un mensaje de AutoSupport:
+
