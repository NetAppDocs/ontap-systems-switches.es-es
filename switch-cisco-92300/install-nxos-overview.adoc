...
summary: 'El software Cisco NX-OS y los archivos de configuración de referencia (RCFs) deben estar instalados en los conmutadores de clúster Cisco Nexus 92300YC.' 
---
