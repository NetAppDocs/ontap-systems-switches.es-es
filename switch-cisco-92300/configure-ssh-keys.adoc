...
summary: SSH es un requisito cuando usas las funciones Cluster Switch Health Monitor y de recopilación de registros. Para habilitar SSH en los switches de clúster Cisco 92300YC, primero generas las claves SSH y luego habilitas SSH. 
---
