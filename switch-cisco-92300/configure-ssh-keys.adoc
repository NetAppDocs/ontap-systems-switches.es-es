...
summary: 'SSH es un requisito cuando se utilizan las funciones Cluster Switch Health Monitor (CSHM) y de recopilación de registros. Para habilitar SSH en los conmutadores de clúster Cisco 92300YC, primero generas las claves SSH y luego habilitas SSH.' 
---
