...
* Para conocer los requisitos iniciales de preparación, el contenido del kit y las precauciones de seguridad, consulte https://["Guía de instalación de hardware de Cisco Nexus serie 9000"^].
