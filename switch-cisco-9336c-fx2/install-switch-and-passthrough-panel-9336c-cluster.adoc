...
* Para conocer los requisitos de preparación inicial, el contenido del kit y las precauciones de seguridad, consulta el link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/hw/aci_9336cfx2_hig/guide/b_n9336cFX2_aci_hardware_installation_guide.html["Guía de instalación de hardware de la serie Cisco Nexus 9000"^].
...
+
En este procedimiento, el panel de obturación se instala en U40.
