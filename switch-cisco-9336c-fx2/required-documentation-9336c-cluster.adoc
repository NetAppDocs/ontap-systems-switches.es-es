...
Para configurar los conmutadores Cisco Nexus 9336C-FX2 y 9336C-FX2-T, necesita la siguiente documentación del sitio web: https://www.cisco.com/c/en/us/support/switches/nexus-9000-series-switches/series.html["Compatibilidad con los switches Cisco Nexus serie 9000"^] página:
