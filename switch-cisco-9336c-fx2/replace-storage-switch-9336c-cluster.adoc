...
---
= Reemplazar un switch de almacenamiento Cisco Nexus 9336C-FX2
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Debe tener en cuenta cierta información de configuración, conexiones de puertos y requisitos de cableado cuando reemplace los switches de almacenamiento Cisco Nexus 9336C-FX2.

.Lo que necesitarás
Debe verificar que se cumplan las siguientes condiciones antes de instalar el software NX-OS y los RCF en un switch de almacenamiento Cisco Nexus 9336C-FX2:

* Su sistema puede admitir conmutadores de almacenamiento Cisco Nexus 9336C-FX2.
* Debes haber consultado la tabla de compatibilidad de switches en la página de switches Ethernet de Cisco para conocer las versiones compatibles de ONTAP, NX-OS y RCF.
* Debes haber consultado las guías de software y actualización correspondientes disponibles en el sitio web de Cisco .  Switches Cisco Nexus serie 3000
* Debes haber descargado los RCF correspondientes.
...
* El switch de reemplazo Cisco Nexus 9336C-FX2 debe tener las siguientes características:
+
...
** La configuración inicial del switch debe estar completa.
