...
summary: Siga este procedimiento para configurar y configurar el switch Cisco Nexus 9336C-FX2. 
---
= Configure el switch de clúster 9336C-FX2
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Introduzca el nombre del switch.
 a| 
Introduzca el nombre del switch, que está limitado a 63 caracteres alfanuméricos.
...
. Compruebe la versión de los switches de red de clúster y, si es necesario, descargue la versión del software que admite NetApp en los switches.
+
Si descarga la versión de software compatible con NetApp, también debe descargar el _archivo de configuración_ de referencia del switch de red del clúster de NetApp y combinarlo con la configuración que guardó en el paso 5. Puede descargar el archivo y las instrucciones desde la https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Switches Ethernet de Cisco"^] página.

. Compruebe la versión del software en los switches de red y, si es necesario, descargue la versión del software compatible con NetApp en los switches. Si dispone de sus propios conmutadores, consulte https://cisco.com["Sitio Cisco"^].
+
Si descarga la versión del software compatible con NetApp, también deberá descargar el _archivo de configuración_ de referencia del switch de red de gestión de NetApp y combinarlo con la configuración que guardó anteriormente. Puede descargar el archivo y las instrucciones desde la https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Switches Ethernet de Cisco"^] página.



.El futuro
Opcionalmente, puede hacerlo link:install-switch-and-passthrough-panel-9336c-cluster.html["Instale un switch Cisco Nexus 9336C-FX2 en un armario de NetApp"]. De lo contrario, vaya a. link:install-nxos-overview-9336c-cluster.html["Prepare la instalación de NX-OS y RCF"].
