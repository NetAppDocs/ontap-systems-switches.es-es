...
Debe estar al tanto de cierta información de configuración, conexiones de puertos y requisitos de cableado cuando reemplaza los switches de clúster NetApp CN1610 por los switches de clústeres Cisco 9336C-FX2.
...
** Puertos ISL habilitados y cableados entre los switches NetApp CN1610 y entre los nuevos switches.
