...
** Consulte https://["Hardware Universe"^] Para todas las versiones de ONTAP compatibles.
...
+
Consulte https://["Hardware Universe"^] para obtener más información sobre el cableado.
...
Consulte https://["Hardware Universe"^] para obtener información acerca de los puertos de clúster para las plataformas.
...
+
La https://["Hardware Universe - interruptores"^] contiene más información sobre el cableado.

+
https://["Hardware Universe - interruptores"^]
