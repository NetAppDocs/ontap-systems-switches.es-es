...
----
====
. Mueva todas las conexiones de nodos de clúster del conmutador cs2 antiguo al nuevo conmutador cs2.
+
*Las conexiones del nodo del clúster se han movido al conmutador cs2-new*

+
image::../media/new_switch_cs1.png[Conexiones del nodo de clúster movidas al switch cs2-new]
...
----
====
. Mueva las conexiones de cs1 al nuevo conmutador cs1.
+
*Las conexiones del nodo del clúster se han movido al nuevo conmutador cs1*

+
image::../media/new_switch_cs2.png[Conexiones del nodo de clúster movidas al switch cs1-new]
