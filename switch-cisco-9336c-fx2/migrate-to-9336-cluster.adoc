...
. En el switch de clúster CS2, apague los puertos conectados a los puertos de clúster de los nodos para conmutar las LIF de clúster:
+
[listing, subs="+quotes"]
----
...
----
. En el switch de clúster CS1, apague los puertos conectados a los puertos de clúster de los nodos para conmutar las LIF de clúster. En el ejemplo siguiente se utiliza el resultado del ejemplo de interfaz del paso 7.
+
[listing, subs="+quotes"]
----
