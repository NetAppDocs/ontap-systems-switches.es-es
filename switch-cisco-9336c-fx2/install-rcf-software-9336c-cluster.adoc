...
[role="lead"]
Instale el archivo de configuración de referencia (RCF) después de configurar los conmutadores Nexus 9336C-FX2 y 9336C-FX2-T por primera vez.
...
. Copia el RCF al bootflash del switch cs1 utilizando uno de los siguientes protocolos de transferencia: FTP, SFTP o SCP.
+
