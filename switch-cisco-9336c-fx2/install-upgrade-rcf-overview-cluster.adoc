...
.El futuro
Después de haber revisado el procedimiento de instalación o actualización de RCF,link:install-rcf-software-9336c-cluster.html["instalar el RCF"] olink:upgrade-rcf-software-9336c-cluster.html["Mejora tu RCF"] según sea necesario.
