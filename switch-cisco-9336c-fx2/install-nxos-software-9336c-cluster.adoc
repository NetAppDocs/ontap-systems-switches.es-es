...
[role="lead"]
Siga este procedimiento para instalar o actualizar el software NX-OS en el switch de cluster Nexus 9336C-FX2.
...
.El futuro
link:install-upgrade-rcf-overview-cluster.html["Instalar o actualizar el archivo de configuración de referencia (RCF)"]
