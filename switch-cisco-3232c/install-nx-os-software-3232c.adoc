...
summary: Puede utilizar este procedimiento para instalar el software NX-OS en el conmutador de clúster Nexus 3232C. 
---
...
[role="lead"]
Puede utilizar este procedimiento para instalar el software NX-OS en el conmutador de clúster Nexus 3232C.
...
.¿Que sigue?
Después de haber instalado el software NX-OS, usted link:install-upgrade-rcf-overview-3232c.html["instalar o actualizar el archivo de configuración de referencia (RCF)"].
