...
summary: Puede utilizar este procedimiento para instalar el software NX-OS en el switch de clúster Nexus 3232C. 
---
...
[role="lead"]
Puede utilizar este procedimiento para instalar el software NX-OS en el switch de clúster Nexus 3232C.
...
. Copie las imágenes del software NX-OS y EPLD en el switch Nexus 3232C.
+
.Muestra el ejemplo
[%collapsible]
====
...
----
====
. Si va a actualizar a NX-OS versión 9,3(11), debe actualizar la imagen EPLD `golden` y reiniciar el conmutador una vez más. De lo contrario, vaya al paso 12.
+
Consulte https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/epld-rn/nxos_n9K_epldRN_9311.html["Notas de la versión de actualización de EPLD, versión 9,3(11)"^] para obtener más información.
...
----
====
. Tras reiniciar el conmutador, inicie sesión para verificar que la nueva versión de EPLD se ha cargado correctamente.
+
.Muestra el ejemplo
[%collapsible]
====
