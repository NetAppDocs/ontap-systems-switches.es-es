...
+
Consulta link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/epld-rn/nxos_n9K_epldRN_9311.html["Notas de la versión de actualización de EPLD, versión 9.3(11)"^] para más detalles.
...
.¿Que sigue?
Una vez instalado el software NX-OS, podrá link:install-upgrade-rcf-overview-3232c.html["instalar o actualizar el archivo de configuración de referencia (RCF)"].
