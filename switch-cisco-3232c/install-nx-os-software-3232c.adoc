...
----
====
. Tras reiniciar el switch, vuelva a iniciar sesión, actualice la imagen dorada de EPLD y reinicie el switch una vez más.
+
.Muestra el ejemplo
[%collapsible]
====
...
.El futuro
link:install-rcf-3132q-v.html["Instale el archivo de configuración RCF"].
