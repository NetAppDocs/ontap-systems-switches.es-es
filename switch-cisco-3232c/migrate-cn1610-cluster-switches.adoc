...
----
====
. Apague los puertos ISL 13 a 16 en el conmutador CL1 CN1610 activo con el comando correspondiente.
+
...
----
====
. Migre las LIF asociadas con el primer switch CL1 CN1610:
+
...
----
====
. [[cuarenta]]Habilitar la función de recopilación de registros del monitor de estado del switch de clúster para recopilar archivos de registro relacionados con el conmutador:
+
