...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-3.png["Tres"]link:install-cisco-nexus-3232c.html["Instale el interruptor en un armario NetApp"]
[role="quick-margin-para"]
