...
summary: Puede instalar RCF después de configurar el switch Nexus 3232C por primera vez. También puede utilizar este procedimiento para actualizar su versión de RCF. 
---
...
[role="lead"]
Siga este procedimiento para instalar el RCF después de configurar el switch Nexus 3232C por primera vez.

También puedes usar este procedimiento para actualizar tu versión de RCF. Consulta el artículo de base de conocimientos link:https://kb.netapp.com/onprem/Switches/Cisco/How_to_clear_configuration_on_a_Cisco_interconnect_switch_while_retaining_remote_connectivity["Cómo borrar la configuración de un switch de interconexión Cisco manteniendo la conectividad remota"^] para más información cuando actualices tu RCF.
...
* link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["página del switch Ethernet de Cisco"^]Consulte la tabla de compatibilidad del switch para conocer las versiones compatibles de ONTAP y RCF.  Tenga en cuenta que puede haber dependencias de comandos entre la sintaxis de comandos en RCF y la que se encuentra en las versiones de NX-OS.
...
Asegúrese de completar el procedimiento enlink:prepare-install-cisco-nexus-3232c.html["Prepárese para instalar NX-OS y RCF."] y luego siga los pasos a continuación.
...
. Registre cualquier adición personalizada entre el actual `running-config` y el archivo RCF en uso.
...
. Copia el RCF al bootflash del switch cs2 usando uno de los siguientes protocolos de transferencia: FTP, TFTP, SFTP o SCP. Para más información sobre los comandos de Cisco, consulta la guía correspondiente en la link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Referencia de comandos de Cisco Nexus serie 3000 NX-OS"^]
+
.Mostrar ejemplo
[%collapsible]
====
...
+
Para más información sobre los comandos de Cisco, consulta la guía correspondiente en la link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Referencia de comandos de Cisco Nexus serie 3000 NX-OS"^]
...
. Vuelva a aplicar cualquier personalización anterior a la configuración del switch.  Referirse alink:cabling-considerations-3232c.html["Revisar las consideraciones de cableado y configuración"] Para obtener detalles sobre cualquier otro cambio necesario.
...
----
====
. Repita los pasos 7 a 23 en el interruptor cs1.
