...
[role="lead"]
Siga este procedimiento para instalar el RCF después de configurar el interruptor Nexus 3232C por primera vez. También puede utilizar este procedimiento para actualizar la versión de RCF.
...
----
. Reinicie el switch cs1.haga esto para activar las LIF de clúster para revertir a sus puertos raíz. Es posible ignorar los eventos "puertos de clúster inactivos" que se informan en los nodos mientras se reinicia el switch.
+
.Muestra el ejemplo
[%collapsible]
====
