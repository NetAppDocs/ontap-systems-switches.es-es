...
summary: Para sustituir los switches de clúster Cisco Nexus 5596 existentes en un clúster con switches de clúster Nexus 3232C, debe realizar una secuencia específica de las tareas. 
---
= Migre de un switch de clúster Cisco Nexus 5596 a un switch de clúster Cisco Nexus 3232C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Siga este procedimiento para migrar un switch de clúster Cisco Nexus 5596 existente en un clúster con switches de clúster Nexus 3232C.
...
* http://["Página de descripción de Cisco Ethernet Switch"^]
...
* Los switches Nexus 3232C para sustituir los switches Nexus 5596 son C1 y C2.
...
* Los otros dos nodos utilizan dos puertos de interconexión de clúster de 40 GbE: e4a y e4e. La link:https://hwu.netapp.com/["_Hardware Universe_"^] la enumera los puertos del clúster reales en las plataformas.
...
+
Consulte la página __ONTAP 8.x o posterior Archivos de configuración de referencia de switches de red de administración y clúster__ Descargar y, a continuación, haga clic en la versión adecuada.
...
----
====
. Apague ISL 41 a 48 en CL1, el switch Nexus 5596 activo con Cisco `shutdown` comando.
+
...
----
====
. Expanda el clúster añadiendo nodos a los switches de clúster Nexus 3232C.
+
