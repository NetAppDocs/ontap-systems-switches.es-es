...
[role="lead"]
Si tiene un entorno de clúster existente de dos nodos _sin switch_, puede migrar a un entorno de clúster de dos nodos _con switches_ mediante los switches Cisco Nexus 9336C-FX2 para permitirle escalar más allá de dos nodos del clúster.
...
+
Consulte https://["Hardware Universe - interruptores"^] para obtener más información sobre el cableado.
