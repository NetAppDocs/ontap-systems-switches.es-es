...
+
Si descarga la versión del software compatible con NetApp, también debe descargar el _archivo de configuración_ de referencia del switch de red de gestión de NetApp y combinarlo con la configuración que guardó en el paso 5. Puede descargar el archivo y las instrucciones desde la https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Switches Ethernet de Cisco"^] página.



.El futuro
Opcionalmente, puede hacerlo link:install-switch-and-passthrough-panel-9336c-storage.html["Instale el switch en el armario de NetApp"]. De lo contrario, vaya a. link:install-nxos-overview-9336c-storage.html["Prepare la instalación de NX-OS y RCF"].
