...
.El futuro
Opcionalmente, puedeslink:install-switch-and-passthrough-panel-9336c-storage.html["Instale un switch Cisco Nexus 9336C-FX2 en un armario de NetApp"] .  De lo contrario, vaya alink:setup-switch-9336c-storage.html["Configure el switch"] .
