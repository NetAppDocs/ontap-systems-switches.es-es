...
--
====
. [[step6]] Apague los puertos ISL 1/35 y 1/36 en el switch Nexus 9336C-FX2 CS1:
+
[listing]
----
cs1# configure
...
--
====
. [[step14]] Confirme la siguiente configuración de red de cluster: `network port show`
+
[listing]
----
cluster1::*> network port show -ipspace Cluster
