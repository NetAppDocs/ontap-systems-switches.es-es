...
* Algunos puertos de los switches Nexus 9336C-FX2 están configurados para funcionar a 10 GbE o 40 GbE.
* La conectividad de 10 GbE y 40 GbE de los nodos a los switches de clúster Nexus 9336C-FX2 ha sido planificada, migrado y documentada.
...
* Tiene acceso a la tabla de compatibilidad del conmutador de https://["Switches Ethernet de Cisco"^] Para las versiones ONTAP, NX-OS y RCF admitidas.
* Ha revisado las guías de actualización y software adecuadas disponibles en el sitio web de Cisco para los procedimientos de actualización y degradación de switches de Cisco en https://["Compatibilidad con los switches Cisco Nexus serie 9000"^] página.
...
El procedimiento requiere el uso de tanto comandos de la ONTAP como de https://["Switches de la serie Nexus 9000"^] Comandos; los comandos de ONTAP se utilizan, a menos que se indique lo contrario.
...
----
====
. Habilite la función de recogida de registros de control de estado del switch Ethernet para recopilar archivos de registro relacionados con el switch.
