...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["Cuatro"]link:install-upgrade-rcf-overview-9336c-storage.html["Instale o actualice el RCF"]
[role="quick-margin-para"]
