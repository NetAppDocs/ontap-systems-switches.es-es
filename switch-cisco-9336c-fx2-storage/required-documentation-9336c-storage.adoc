...
---
= Requisitos de documentación de los switches de almacenamiento Cisco Nexus 9336C-FX2
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Para configurar los switches Cisco Nexus 9336C-FX2, necesita la siguiente documentación del https://["Compatibilidad con los switches Cisco Nexus serie 9000"^] página:
