...
IMPORTANT: Al habilitar FIPS, debes cambiar el recuento de bits a 256 en el switch usando el comando `ssh key ecdsa 256 force`. Consulta link:https://docs.netapp.com/us-en/ontap/networking/configure_network_security_using_federal_information_processing_standards_@fips@.html#enable-fips["Configure la seguridad de la red utilizando FIPS."^] para más detalles.
