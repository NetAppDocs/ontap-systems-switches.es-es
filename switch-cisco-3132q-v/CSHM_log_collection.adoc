...
.Antes de empezar
* Compruebe que ha configurado su entorno mediante el conmutador de clúster de Cisco 3132Q-V *CLI*.
...
====
+
Espere 10 minutos y compruebe que se complete la recogida de registros:
