...
---
= Reemplace los conmutadores de clúster Cisco Nexus 3132Q-V con conexiones sin conmutador
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[NOTE]
====
NetApp recomienda que actualice su versión de ONTAP antes de proceder con la operación de clúster conmutado a sin conmutador para los conmutadores Cisco Nexus 3132Q-V.

Para más detalles, véase lo siguiente:

* link:https://kb.netapp.com/Support_Bulletins/Customer_Bulletins/SU540["SU540: Los errores de la tarjeta de red Chelsio T6 provocan el apagado del sistema al actualizar de switches de red de 40G a 100G."^]
* link:https://kb.netapp.com/on-prem/ontap/OHW/OHW-KBs/Node_panic_after_migration_from_switched_to_switchless_cluster["Pánico de nodo tras la migración de un clúster conmutado a uno sin conmutación"^]
