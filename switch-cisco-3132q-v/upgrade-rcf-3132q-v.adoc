...
+
Para obtener más información sobre los comandos de Cisco, consulta la guía correspondiente en https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Referencia de comandos de Cisco Nexus serie 3000 NX-OS"^].
...
NOTE: Para saber cómo poner en línea tus puertos 10GbE después de actualizar el RCF, consulta el artículo de base de conocimientos link:https://kb.netapp.com/onprem%2FSwitches%2FCisco%2F10GbE_ports_on_Cisco_3132Q_cluster_switch_do_not_come_online["Los puertos 10GbE de un switch de clúster Cisco 3132Q no se activan."^].
...
+
Para obtener más información sobre los comandos de Cisco, consulta la guía correspondiente en link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Referencia de comandos de Cisco Nexus serie 3000 NX-OS"^]. .Mostrar ejemplo
