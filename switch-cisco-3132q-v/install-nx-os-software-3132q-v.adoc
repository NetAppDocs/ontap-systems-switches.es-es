...
summary: Puede utilizar este procedimiento para instalar el software NX-OS en el conmutador de clúster Nexus 3132Q-V. 
---
...
[role="lead"]
Siga este procedimiento para instalar el software NX-OS en el switch de clúster Nexus 3132Q-V.
...
* link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["conmutador Ethernet de Cisco"^]. Consulte la tabla de compatibilidad del switch para conocer las versiones compatibles de ONTAP y NX-OS.
...
. Copia el software NX-OS al switch Nexus 3132Q-V usando uno de los siguientes protocolos de transferencia: FTP, TFTP, SFTP o SCP. Para más información sobre los comandos de Cisco, consulta la guía correspondiente en link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Referencia de comandos de Cisco Nexus serie 3000 NX-OS"^].
+
.Mostrar ejemplo
[%collapsible]
====
...
----
====
. Repita los pasos 6 a 11 en el interruptor cs1.
...
.¿Que sigue?
Una vez instalado el software NX-OS, podrá link:install-upgrade-rcf-overview-3132q-v.html["instalar o actualizar el archivo de configuración de referencia (RCF)"].
