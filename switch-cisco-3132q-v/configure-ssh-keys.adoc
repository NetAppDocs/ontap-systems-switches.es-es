...
summary: 'SSH es un requisito cuando usas las funciones Cluster Switch Health Monitor (CSHM) y de recopilación de registros. Para habilitar SSH en los switches de clúster Cisco 3132Q-V, primero generas las claves SSH y luego habilitas SSH.' 
---
