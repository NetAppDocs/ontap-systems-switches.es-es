...
summary: SSH es un requisito cuando se utilizan las funciones Cluster Switch Health Monitor y de recopilación de registros. Para habilitar SSH en los conmutadores de clúster Cisco 3132Q-V, primero generas las claves SSH y luego habilitas SSH. 
---
