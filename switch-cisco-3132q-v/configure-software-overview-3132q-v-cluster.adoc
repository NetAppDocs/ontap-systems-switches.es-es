...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-1.png["1"]link:setup-switch.html["Configura el interruptor"]
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["Cuatro"]link:install-upgrade-rcf-overview-3132q-v.html["Instalar o actualizar el RCF"]
[role="quick-margin-para"]
Instala o actualiza el RCF después de configurar el conmutador Cisco 3132Q-V.
