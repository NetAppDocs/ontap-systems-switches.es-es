...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-1.png["Uno"]link:setup-worksheet-3132q.html["Complete la hoja de trabajo de cableado"]
