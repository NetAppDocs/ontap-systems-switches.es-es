...
summary: 'El software Cisco NX-OS y los archivos de configuración de referencia (RCF) deben instalarse en los switches de clúster Cisco Nexus 3132Q-V.' 
---
= Prepárese para instalar el software NX-OS y el archivo de configuración de referencia.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.¿Que sigue?
Después de haberte preparado para instalar el software NX-OS y RCF, link:install-nx-os-software-3132q-v.html["Instalar el software NX-OS"].
