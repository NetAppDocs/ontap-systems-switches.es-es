...
summary: 'SSH es un requisito cuando se utilizan el Monitor de estado del conmutador de clúster (CSHM) y las funciones de recopilación de registros. Para habilitar SSH en los conmutadores de clúster Cisco 9332d-gx2b, primero genere las claves SSH y luego habilite SSH.' 
---
