...
summary: SSH es un requisito cuando se utilizan las funciones Cluster Switch Health Monitor y de recopilación de registros. Para habilitar SSH en los conmutadores de clúster Cisco 9332d-gx2b, primero generas las claves SSH y luego habilitas SSH. 
---
