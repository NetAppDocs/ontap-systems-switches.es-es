...
summary: La sustitución de un conmutador Nexus 9332D-GX2B defectuoso en una red de clúster es un procedimiento sin interrupciones. 
---
...
** La personalización inicial del interruptor está completa, tal como se detalla enlink:setup-switch-9332d-cluster.html["Configurar el conmutador de clúster 9332D-GX2B"] .
+
