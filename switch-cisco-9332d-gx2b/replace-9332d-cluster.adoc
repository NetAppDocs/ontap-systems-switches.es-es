...
summary: 'Sigue estos pasos para sustituir un conmutador Nexus 9332D-GX2B defectuoso en una red de clúster. Este es un procedimiento sin interrupción del servicio (NDU).' 
---
= Reemplaza un switch - Cisco Nexus 9332D-GX2B
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
** La personalización inicial del switch está completa, como se detalla en link:configure-complete-initial-setup-9332d.html["Completa la configuración inicial del conmutador"].
+
...
* Activa un mantenimiento AutoSupport antes y después del mantenimiento para desactivar la creación de casos durante el mantenimiento. Consulta este artículo de base de conocimientos https://kb.netapp.com/Support_Bulletins/Customer_Bulletins/SU92["SU92: Cómo suprimir la creación automática de casos durante las ventanas de mantenimiento programadas"^] para más detalles.
...
----
====
. Activa todos los puertos, Eth1/1 a Eth1/30, en el switch newcs2.
+
.Mostrar ejemplo
[%collapsible]
====
...
. Verifique la conectividad de las interfaces del clúster remoto:
+
.. Puedes usar el `network interface check cluster-connectivity` comando para mostrar los detalles de una comprobación de accesibilidad para la conectividad del clúster:
+
[source, cli]
----
