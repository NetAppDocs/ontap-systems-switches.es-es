...
summary: 'El software Cisco NX-OS y los archivos de configuración de referencia (RCF) deben estar instalados en los conmutadores de clúster Cisco Nexus 9332D-GX2B.' 
---
...
.. *Puertos de clúster*
+
... Muestra cuántas interfaces de interconexión de clúster están configuradas en cada nodo para cada conmutador:
+
[source, cli]
----
...
.. *Puertos HA*
+
... Mostrar información sobre los puertos HA:
+
...
+
... Mostrar información sobre los puertos de almacenamiento:
+
[source, cli]
----
...
. Verificar la conectividad de las interfaces del clúster remoto.
+
...
. Verifique que el comando de reversión automática esté habilitado en todos los LIF del clúster:
+
[source, cli]
----
...
.¿Que sigue?
Después de haberte preparado para instalar el software NX-OS y RCF, link:install-nxos-software-9332d-cluster.html["instalar o actualizar el software NX-OS"].
