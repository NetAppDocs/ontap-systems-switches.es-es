...
summary: 'Actualizas la versión del archivo de configuración de referencia (RCF) en tus switches Cisco Nexus 9332D-GX2B para admitir nuevo hardware, una nueva versión de ONTAP o para alinearla con una nueva versión de NX-OS en la configuración de tu sistema AFX 1K o AFX 2K.' 
---
= Actualizar la versión de RCF - Cisco Nexus 9332D-GX2B
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Actualizas la versión del archivo de configuración de referencia (RCF) en tus switches Cisco Nexus 9332D-GX2B para admitir nuevo hardware, una nueva versión de ONTAP o para alinearla con una nueva versión de NX-OS en la configuración de tu sistema AFX 1K o AFX 2K.


NOTE: No actualices ni cambies tu versión de RCF a una versión no compatible.

.Antes de empezar
* Debes haber leído la página link:configure-install-upgrade-rcf-overview-9332d.html["Descripción general de la instalación o actualización de RCF"].
...
CAUTION: Asegúrate de apagar *todos* los puertos conectados para evitar cualquier problema de conexión a la red. Consulta el artículo de base de conocimientos https://kb.netapp.com/on-prem/ontap/OHW/OHW-KBs/Node_out_of_quorum_when_migrating_cluster_lif_during_switch_OS_upgrade["Nodo fuera de quórum al migrar la LIF del clúster durante la actualización del sistema operativo del switch"^] para más detalles.
...
+
Si tus conmutadores están ejecutando RCF 10.1 o una versión posterior, puedes link:configure-install-upgrade-rcf-overview-9332d.html#change-port-speed-configuration["cambia la configuración de la velocidad del puerto"] si lo necesitas.
...
.¿Que sigue?
Una vez que hayas actualizado el RCF en tus conmutadores, link:configure-verify-ssh-9332d.html["Verifica SSH para la recopilación de registros"].
