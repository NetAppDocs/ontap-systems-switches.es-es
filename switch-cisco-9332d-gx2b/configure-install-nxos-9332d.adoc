...
summary: 'Instalas el sistema operativo NX-OS en tu(s) switch(es) Cisco Nexus 9332D-GX2B como parte de la instalación de un nuevo sistema AFX 1K o AFX 2K, de la sustitución de un switch o del restablecimiento de un switch a los valores predeterminados de fábrica.' 
---
...
+
** Si tus conmutadores tienen la versión actual compatible con NetApp, no necesitas instalar el NX-OS. Debes instalar el RCF. Empieza con el link:configure-install-upgrade-rcf-overview-9332d.html["Instalar o actualizar la descripción general de RCF"].
...
.¿Que sigue?
Después de que hayas instalado el NX-OS en tus conmutadores, instala RCF comenzando con el link:configure-install-upgrade-rcf-overview-9332d.html["Instalar o actualizar la descripción general de RCF"].
