...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["Cuatro"]link:install-upgrade-rcf-overview-cluster-9332d.html["Instalar o actualizar el RCF"]
[role="quick-margin-para"]
