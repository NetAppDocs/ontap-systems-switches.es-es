...
summary: Puede utilizar este procedimiento para instalar o actualizar el software NX-OS en el conmutador de clúster Nexus 9332D-GX2B. 
---
...
[role="lead"]
Siga este procedimiento para instalar o actualizar el software NX-OS en el conmutador Nexus 9332D-GX2B.
...
* Complete el procedimiento enlink:install-nxos-overview-9332d-cluster.html["Prepárese para instalar NX-OS y RCF."] .
...
----
. Copie el software NX-OS y las imágenes EPLD al conmutador Nexus 9332D-GX2B.
+
.Mostrar ejemplo
[%collapsible]
====
...
----
====
. Repita los pasos 6 a 13 para instalar el software NX-OS y las imágenes EPLD en el conmutador cs1.
...
.¿Que sigue?
Después de haber instalado o actualizado el software NX-OS, puedes link:install-upgrade-rcf-overview-cluster-9332d.html["instalar o actualizar el archivo de configuración de referencia (RCF)"].
