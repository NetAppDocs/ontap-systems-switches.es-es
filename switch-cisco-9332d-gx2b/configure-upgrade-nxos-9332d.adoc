...
Instalas NX-OS en el primer conmutador (cs1) instalando y verificando las nuevas versiones de NX-OS y EPLD, comprobando el estado de todos los puertos del clúster y luego repites estos pasos en el segundo conmutador (cs2).
