...
** Consulta el  https://hwu.netapp.com["Hardware Universe"^] para ver todas las versiones de ONTAP compatibles.
...
+
Consulta https://hwu.netapp.com["Hardware Universe"^] para más información sobre el cableado.
