...
* RCF de red compartida y red de administración de NetApp aplicables descargados del sitio de soporte de NetApp en http://mysupport.netapp.com/["mysupport.netapp.com"^] .  Todos los conmutadores de red compartida y de red de administración de Cisco llegan con la configuración predeterminada de fábrica estándar de Cisco .  Estos conmutadores también tienen la versión actual del software NX-OS pero no tienen los RCF cargados.
* link:required-documentation-9332d-cluster.html["Documentación necesaria sobre el switch y ONTAP"] .
...
. Verifique la versión en los conmutadores de red compartidos y, si es necesario, descargue la versión del software compatible con NetApp en los conmutadores desde el https://software.cisco.com/download/home["Descarga de software de Cisco"^] página.


.El futuro
Después de haber configurado sus conmutadores,link:install-nxos-overview-9332d-cluster.html["Prepárese para instalar el software NX-OS y RCF"] .
