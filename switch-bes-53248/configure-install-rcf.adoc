...
+
.. Si se han instalado licencias de puerto adicionales en el switch, debe modificar el RCF para configurar los puertos con licencia adicionales. Verlink:configure-licenses.html#activate-newly-licensed-ports["Activar los puertos recién licenciados"] Para más detalles.
