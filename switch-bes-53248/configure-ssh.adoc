...
summary: 'SSH es un requisito cuando usas las funciones de Cluster Switch Health Monitor (CSHM) y de recopilación de registros. Para habilitar SSH en los switches de clúster BES-53248, primero generas las claves SSH y luego habilitas SSH.' 
---
