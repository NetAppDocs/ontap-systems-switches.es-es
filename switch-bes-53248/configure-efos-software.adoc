...
----
====
. Finalice la instalación.  Siga estos cinco pasos para reconfigurar el conmutador:
+
...
----
====
. Finalice la instalación.  El switch se reinicia sin ninguna configuración aplicada y se restablece a los valores predeterminados de fábrica.  Siga estos seis pasos para reconfigurar el conmutador:
+
