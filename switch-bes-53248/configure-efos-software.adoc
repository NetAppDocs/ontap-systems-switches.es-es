...
summary: Sigue estos pasos para instalar el software Ethernet Fabric OS EFOS en el conmutador de clúster BES-53248. 
---
...
.¿Qué sigue?
Una vez que hayas instalado el software EFOS, puedes:

* link:configure-licenses.html["Instala tus licencias"].
* link:efos-install-rcf-license-file.html["Instala el RCF y el archivo de licencia para EFOS 3.12.0.1 y versiones posteriores"], si aplica a tu configuración.
