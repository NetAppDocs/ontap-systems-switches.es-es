...
---
= Instala el archivo de configuración de referencia (RCF) y el archivo de licencia
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
A partir de EFOS 3.12.0.1, puedes instalar el RCF y el archivo de licencia después de configurar el switch de clúster BES-53248.


CAUTION: Todos los puertos se configuran al instalar RCF, pero necesita instalar su licencia para activar los puertos configurados.
...
* El RCF actual, disponible en la página link:https://mysupport.netapp.com/site/products/all/details/broadcom-cluster-switches/downloads-tab["Conmutadores de clúster Broadcom"^].
...
. Copie el RCF a la memoria flash de arranque del switch cs2 utilizando uno de los siguientes protocolos de transferencia: FTP, HTTP, TFTP, SFTP o SCP.
+
Este ejemplo muestra el uso de HTTP para copiar un RCF a la memoria flash de arranque en el switch cs2:
...
----
====
. En el switch, verifique que se hayan realizado los cambios:
+
[source, cli]
----
show running-config
...
--
====
. [[step21]]En el conmutador de clúster cs1, apague los puertos conectados a los puertos de clúster de los nodos.
+
...
.¿Que sigue?
Una vez instalados RCF y el archivo de licencia, puedes link:configure-ssh.html["habilitar SSH"].
