...
---
= Instale el archivo de configuración de referencia (RCF) y el archivo de licencia.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
A partir de EFOS 3.12.0.1, puede instalar el archivo de configuración de referencia (RCF) y el archivo de licencia después de configurar el conmutador de clúster BES-53248.
...
* El RCF actual, disponible en el https://mysupport.netapp.com/site/products/all/details/broadcom-cluster-switches/downloads-tab["Conmutadores de clúster Broadcom"^] página.
