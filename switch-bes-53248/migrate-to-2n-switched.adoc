...
+
La link:https://hwu.netapp.com/Home/Index["Hardware Universe"^] contiene la información más reciente sobre los puertos de clúster reales para tus plataformas.
...
+
El link:https://hwu.netapp.com/Home/Index["Hardware Universe"^] contiene más información sobre el cableado.
