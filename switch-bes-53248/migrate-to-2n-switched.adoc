...
.El futuro
Una vez finalizada la migración, es posible que necesite instalar el archivo de configuración necesario para admitir el monitor de estado del switch Ethernet (CSHM) para los switches de cluster BES-53248. Consulte link:CSHM_log_collection.html["Habilite la recogida de registros"].
