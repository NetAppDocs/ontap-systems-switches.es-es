...
summary: 'Puede actualizar el archivo de configuración de referencia (RCF) después de configurar el conmutador de clúster BES-53248 y después de aplicar nuevas licencias.' 
---
...
[role="lead"]
Puede actualizar el archivo de configuración de referencia (RCF) después de actualizar el EFOS del conmutador de clúster BES-53248 y después de aplicar nuevas licencias.
...
* Consulte la tabla de compatibilidad del switch para conocer las versiones compatibles de ONTAP y RCF.  Ver el https://mysupport.netapp.com/site/info/broadcom-cluster-switch["Descarga del software EFOS"^] página.  Tenga en cuenta que puede haber dependencias de comandos entre la sintaxis de comandos en RCF y la que se encuentra en las versiones de EFOS.
* Consulte las guías de software y actualización correspondientes disponibles en https://www.broadcom.com/support/bes-switch["Broadcom"^] Sitio para la documentación completa sobre los procedimientos de actualización y degradación del switch BES-53248.
...
* Los ejemplos de este procedimiento utilizan cuatro nodos.  Estos nodos utilizan dos puertos de interconexión de clúster 10GbE. `e0a` y `e0b` .  Ver el https://hwu.netapp.com/Home/Index["Hardware Universe"^] para verificar los puertos de clúster correctos en sus plataformas.
...
+
.. Si se han instalado licencias de puerto adicionales en el switch, debe modificar el RCF para configurar los puertos con licencia adicionales. Ver link:configure-licenses.html#activate-newly-licensed-ports["Activar los puertos recién licenciados"] Para más detalles. Sin embargo, cuando se actualiza a RCF 1.12 o posterior, las modificaciones ya no son necesarias porque todas las interfaces están ahora preconfiguradas.
