...
----
====
. Confirme que las conexiones de los puertos del switch sean correctas desde la perspectiva del switch CS2 mediante los comandos:
+
[listing, subs="+quotes"]
----
cs2# *show port all*
...
----
====
. Confirme que las conexiones de los puertos del switch sean correctas desde la perspectiva del switch CS1 mediante los comandos:
+
[listing, subs="+quotes"]
----
cs1# *show port all*
...
IMPORTANT: Para habilitar la función de recopilación de registros, debe ejecutar ONTAP 9.10.1P15, 9.11.1P12 o 9.12.1 y versiones posteriores, y EFOS 3.8.0.2 y versiones posteriores.
