...
La https://["_Hardware Universe_ de NetApp"^] Contiene información acerca de la compatibilidad con ONTAP, el firmware EFOS compatible y el cableado para switches de clúster BES-53248.
...
+
A continuación, debe volver a conectar los puertos desconectados de todos los nodos al nuevo conmutador BES-53248 cs2. Consulte la https://["_Hardware Universe_ de NetApp"^] para ver las opciones de cableado aprobadas.
...
+
A continuación, debe volver a conectar los puertos desconectados de todos los nodos al nuevo conmutador BES-53248 cs1. Consulte la https://["_Hardware Universe_ de NetApp"^] para ver las opciones de cableado aprobadas.
