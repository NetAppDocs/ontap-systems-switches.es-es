...
IMPORTANT: Consulte link:cabling-considerations-sn2100-cluster.html["Revise las consideraciones sobre el cableado y la configuración"] para obtener advertencias e información adicional. La https://["Hardware Universe - interruptores"^] también contiene más información sobre el cableado.
