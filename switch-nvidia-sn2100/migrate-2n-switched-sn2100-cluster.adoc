...
IMPORTANT: Consulta link:cabling-considerations-sn2100-cluster.html["Revisar las consideraciones de cableado y configuración"] para advertencias y más detalles. El link:https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe - Interruptores"^] también contiene más información sobre el cableado.
