...
Debes tener en cuenta cierta información de configuración, conexiones de puertos y requisitos de cableado cuando reemplaces los switches de clúster NetApp CN1610 por switches de clúster NVIDIA SN2100. Consulta link:configure-overview-sn2100-cluster.html["Descripción general de la instalación y configuración de los switches NVIDIA SN2100"].
...
Para obtener detalles sobre los puertos compatibles y sus configuraciones, consulta el link:https://hwu.netapp.com/["Hardware Universe"^].
