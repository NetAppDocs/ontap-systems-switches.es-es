...
summary: Puede migrar sin interrupciones los conmutadores de clúster NetApp CN1610 para un clúster ONTAP a conmutadores de red de clúster NVIDIA SN2100. 
---
...
Debe tener en cuenta cierta información de configuración, conexiones de puertos y requisitos de cableado cuando reemplace los conmutadores de clúster NetApp CN1610 con conmutadores de clúster NVIDIA SN2100. Verlink:configure-overview-sn2100-cluster.html["Descripción general de la instalación y configuración de los switches NVIDIA SN2100"] .
