...
--
====
Consulta el artículo de base de conocimientos link:https://kb.netapp.com/Advice_and_Troubleshooting/Data_Storage_Systems/Fabric_Interconnect_and_Management_Switches/NVIDIA_SN2100_switch_fails_to_connect_using_40_100GbE_copper_cable["El switch SN2100 no se conecta usando cables de cobre 40/100GbE."^] para más detalles.
...
--
====
Consulta el link:https://hwu.netapp.com/Switch/Index["Hardware Universe"^] y el artículo de base de conocimientos link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["¿Qué información adicional necesito para instalar mi equipo que no está en HWU?"^] para más información.
