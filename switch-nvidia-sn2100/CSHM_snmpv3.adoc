...
----
====
. Compruebe que el número de serie que se va a consultar con el usuario SNMPv3 recién creado es el mismo que se detalla en el paso anterior una vez que se haya completado el período de sondeo de CSHM.
+
