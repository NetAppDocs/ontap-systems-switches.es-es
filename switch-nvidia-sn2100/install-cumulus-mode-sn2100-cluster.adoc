...
summary: Cumulus Linux CL OS puede instalarse cuando el conmutador está ejecutando Cumulus Linux o ONIE. 
---
...
NOTE: El sistema operativo Cumulus Linux (CL) puede instalarse cuando el switch está ejecutando Cumulus Linux o ONIE (consulta link:install-onie-mode-sn2100-cluster.html["Instalar en modo ONIE"]).
...
----
+
Consulta el artículo de base de conocimientos link:https://kb.netapp.com/on-prem/Switches/Nvidia-KBs/NTP_Server_configuration_is_not_working_with_NVIDIA_SN2100_Switches["La configuración del servidor NTP no funciona con los switches NVIDIA SN2100."^] para más detalles.
...
----
+
Consulta https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-54/System-Configuration/Authentication-Authorization-and-Accounting/User-Accounts/["Cuentas de usuario de NVIDIA"^] para más información.
...
Consulta https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-511/System-Configuration/Authentication-Authorization-and-Accounting/User-Accounts/["Cuentas de usuario de NVIDIA"^] para más información.
