...
Debes tener en cuenta cierta información de configuración, conexiones de puertos y requisitos de cableado cuando reemplaces algunos switches de cluster Cisco antiguos por switches de cluster NVIDIA SN2100. Consulta link:configure-overview-sn2100-cluster.html["Descripción general de la instalación y configuración de los switches NVIDIA SN2100"].
...
Para obtener detalles sobre los puertos compatibles y sus configuraciones, consulta la link:https://hwu.netapp.com/["Hardware Universe"^].
...
NOTE: Si estás cambiando la velocidad de puerto de los puertos de clúster e0a y e1a en sistemas AFF A800 o AFF C800, podrías observar que se reciben paquetes malformados después de la conversión de velocidad. Consulta link:https://mysupport.netapp.com/site/bugs-online/product/ONTAP/BURT/1570339["Error 1570339"^] y el artículo de base de conocimientos link:https://kb.netapp.com/onprem/ontap/hardware/CRC_errors_on_T6_ports_after_converting_from_40GbE_to_100GbE["Errores CRC en puertos T6 tras la conversión de 40GbE a 100GbE"^] para orientación.
