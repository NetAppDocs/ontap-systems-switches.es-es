...
[role="lead"]
Puede migrar desde switches Cisco antiguos para un clúster ONTAP a switches de almacenamiento NVIDIA SN2100. Este es un procedimiento que no produce interrupciones.



== Requisitos de revisión

Debe tener en cuenta cierta información de configuración, conexiones de puertos y requisitos de cableado cuando reemplace algunos switches Cisco antiguos con switches de almacenamiento NVIDIA SN2100. Verlink:configure-overview-sn2100-cluster.html["Descripción general de la instalación y configuración de los switches NVIDIA SN2100"] .
...
** Todas las LIF del clúster en estado *activo* con las LIF del clúster están en sus puertos de inicio.
** Puertos ISL habilitados y cableados entre los switches Cisco antiguos y entre los switches nuevos.


* Algunos de los puertos de los switches NVIDIA SN2100 están configurados para funcionar a 100 GbE.
...
----
====
. Los puertos de almacenamiento de cada nodo se conectan a los conmutadores de almacenamiento existentes de la siguiente manera (desde la perspectiva de los nodos) mediante el siguiente comando:
+
...
----
====
. En los switches S1 y S2, los puertos de almacenamiento y los switches están conectados de la siguiente manera (desde la perspectiva de los switches) utilizando el comando:
+
`show lldp neighbors`
...
----
====
. Los puertos de almacenamiento de cada nodo ahora están conectados a los conmutadores de la siguiente manera, desde la perspectiva de los nodos:
+
.Mostrar ejemplo
[%collapsible]
====
...
. Cree una contraseña para la función de recopilación de registros del monitor de estado del switch Ethernet:
+
