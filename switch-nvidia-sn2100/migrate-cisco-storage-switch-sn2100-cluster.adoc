...
Debes tener en cuenta cierta información de configuración, conexiones de puertos y requisitos de cableado cuando reemplaces algunos switches Cisco antiguos por switches de almacenamiento NVIDIA SN2100. Consulta link:configure-overview-sn2100-cluster.html["Descripción general de la instalación y configuración de los switches NVIDIA SN2100"].
