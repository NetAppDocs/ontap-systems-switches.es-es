...
NOTE: Para más información sobre la instalación de Cumulus Linux, consulta link:configure-software-overview-sn2100-cluster.html["Flujo de trabajo de instalación de software para switches NVIDIA SN2100"].
...
Consulta la documentación de NVIDIA link:https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-511/Installation-Management/Factory-Reset/["Restablecimiento de fábrica"^] para más detalles.
