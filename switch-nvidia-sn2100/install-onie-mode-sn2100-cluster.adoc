...
NOTE: El sistema operativo Cumulus Linux (CL) puede instalarse cuando el switch está ejecutando ONIE o Cumulus Linux (consulta link:install-cumulus-mode-sn2100-cluster.html["Instalar en modo Cumulus"]).
...
.Cumulus Linux 4.4.3
--
. Descargue el archivo de instalación de Cumulus Linux al directorio raíz del servidor web.  Cambiar el nombre de este archivo a: `onie-installer` .
...
----
. Verifique la versión de Cumulus para Linux: `net show version`
+
[listing, subs="+quotes"]
----
...
Retype new password: *<new_password>*
----
. Verifique la versión de Cumulus para Linux: `nv show system`
+
[listing, subs="+quotes"]
----
...
====
.¿Que sigue?
Una vez instalado Cumulus Linux en modo ONIE, puedeslink:install-rcf-sn2100-cluster.html["Instalar el script del archivo de configuración de referencia (RCF)."] .
