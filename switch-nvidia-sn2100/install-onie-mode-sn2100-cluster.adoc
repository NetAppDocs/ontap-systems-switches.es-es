...
====
.El futuro
Después de instalar Cumulus Linux en modo ONIE, puedeslink:install-rcf-sn2100-cluster.html["Instalar el script del archivo de configuración de referencia (RCF)."] .
