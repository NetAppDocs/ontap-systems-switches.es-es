...
NOTE: El sistema operativo Cumulus Linux (CL) se puede instalar tanto si el switch ejecuta ONIE como si ejecuta Cumulus Linux (véaselink:install-cumulus-mode-sn2100-cluster.html["Instalar en modo Cumulus"] ).
