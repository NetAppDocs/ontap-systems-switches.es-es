...
---
= Actualice el script Reference Configuration File (RCF)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Lo que necesitará
Antes de actualizar la secuencia de comandos RCF, asegúrese de que están disponibles los siguientes elementos en el conmutador:
