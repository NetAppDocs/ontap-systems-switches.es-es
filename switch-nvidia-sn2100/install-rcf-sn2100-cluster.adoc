...
Hay dos scripts de RCF disponibles para las aplicaciones de clúster y almacenamiento. Descargar RCFs desde https://mysupport.netapp.com/site/info/nvidia-cluster-switch["aquí"^]. El procedimiento para cada uno es el mismo.
