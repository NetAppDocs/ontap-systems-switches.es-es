...
* Está instalado Cumulus Linux. Consulte https://["Hardware Universe"^] para las versiones compatibles.
...
Hay dos scripts de RCF disponibles para las aplicaciones de clúster y almacenamiento. Descargar RCFs desde https://["aquí"^]. El procedimiento para cada uno es el mismo.
...
----
. Aplique el script python de RCF *MSN2100-RCF-v1.x-Cluster-HA-Breakout-LLDP*.
+
[listing, subs="+quotes"]
----
...
NOTE: Para cualquier problema de script de Python de RCF que no se pueda corregir, póngase en contacto con https://["Soporte de NetApp"^] para obtener ayuda.
