...
summary: Cuando instales un archivo de configuración de referencia RCF, primero debes migrar los LIF del clúster fuera del switch cs2. Después de que el RCF esté instalado y validado, los LIF se pueden migrar de vuelta. 
---
