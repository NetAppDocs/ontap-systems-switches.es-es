...
----
====
. Verifica que las versiones del switch y de ONTAP coincidan en la matriz de compatibilidad. Consulta link:https://mysupport.netapp.com/site/info/netapp-cluster-switch["Switches NetApp CN1601 y CN1610"^] para más detalles.
. Desde el link:https://mysupport.netapp.com/site/products/all/details/netapp-cluster-switches/downloads-tab["Página de descargas de software"^] en el sitio de soporte de NetApp, selecciona NetApp Cluster Switches para descargar las versiones RCF y FASTPATH adecuadas.
