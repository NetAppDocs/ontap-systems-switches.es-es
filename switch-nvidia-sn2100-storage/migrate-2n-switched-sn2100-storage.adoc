...
NOTE: Consulta link:cabling-considerations-sn2100-storage.html["Consideraciones sobre el cableado y la configuración"] para ver advertencias y más detalles.
...
+
La link:https://hwu.netapp.com["Hardware Universe"^] contiene la información más reciente sobre los puertos reales del clúster para tus plataformas.
...
. En el switch sw1, habilite todos los puertos orientados hacia el nodo.
+
.Mostrar ejemplo
[%collapsible]
====
...
. En el switch sw2, habilite todos los puertos orientados hacia el nodo.
+
.Mostrar ejemplo
[%collapsible]
====
...
----
====
. En ambos conmutadores, sw1 y sw2, verifique que cada nodo tenga una conexión a cada conmutador:
+
`net show lldp`
...
--
====
. [[step8]] Habilite la función de recopilación de registros del monitor de estado del switch Ethernet para recopilar archivos de registro relacionados con el switch, utilizando los siguientes comandos:
+
