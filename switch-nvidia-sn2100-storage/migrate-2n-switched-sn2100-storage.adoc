...
NOTE: Verlink:cabling-considerations-sn2100-storage.html["Consideraciones sobre el cableado y la configuración"] Para conocer las salvedades y obtener más detalles.
