...
NOTE: El sistema operativo Cumulus Linux (CL) se puede instalar cuando el switch ejecuta Cumulus Linux u ONIE (véaselink:install-onie-mode-sn2100-storage.html["Instalar en modo ONIE"] ).
