...
NOTE: El sistema operativo Cumulus Linux (CL) puede instalarse cuando el switch está ejecutando Cumulus Linux o ONIE (consulta link:install-onie-mode-sn2100-storage.html["Instalar en modo ONIE"]).
...
Consulta link:https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-511/System-Configuration/Authentication-Authorization-and-Accounting/User-Accounts/["Cuentas de usuario de NVIDIA"^] para más información.

--
====
.¿Que sigue?
Una vez que hayas instalado Cumulus Linux en modo Cumulus, podráslink:install-rcf-sn2100-storage.html["Instalar o actualizar el script RCF"] .
