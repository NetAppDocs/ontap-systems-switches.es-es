...
NOTE: Para obtener más información sobre la instalación de Cumulus Linux, consultelink:configure-software-sn2100-storage.html["Flujo de trabajo de instalación de software para switches NVIDIA SN2100"] .
