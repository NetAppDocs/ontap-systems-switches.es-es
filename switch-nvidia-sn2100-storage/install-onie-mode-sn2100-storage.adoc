...
NOTE: El sistema operativo Cumulus Linux (CL) puede instalarse cuando el switch está ejecutando Cumulus Linux u ONIE (consulta link:install-cumulus-mode-sn2100-storage.html["Instalar en modo Cumulus"]).
