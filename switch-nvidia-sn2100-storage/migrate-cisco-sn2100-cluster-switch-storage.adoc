...
* Consulte https://["Hardware Universe"^] para obtener toda la información de los puertos compatibles y sus configuraciones.
...
----
. Compruebe que la red de clúster tiene conectividad completa mediante el comando: `cluster ping-cluster -node node-name`
+
[listing, subs="+quotes"]
----
