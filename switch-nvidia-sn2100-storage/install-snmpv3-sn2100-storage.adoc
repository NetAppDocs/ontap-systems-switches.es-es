...
summary: Esta versión incluye soporte para SNMPv3 para la supervisión de registros. 
---
= Configure SNMPv3 para la recopilación de registros del conmutador
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Siga este procedimiento para configurar SNMPv3, que admite la recopilación de registros de conmutación y la supervisión del estado del conmutador (SHM).

.Acerca de esta tarea
Los siguientes comandos configuran un nombre de usuario SNMPv3 en switches NVIDIA SN2100:
...
----
====
. Configure SHM para supervisar con el nuevo usuario SNMPv3:
+
...
----
====
. Compruebe que el número de serie que se va a consultar con el usuario SNMPv3 recién creado es el mismo que se detalla en el paso anterior una vez completado el período de sondeo SHM.
+
