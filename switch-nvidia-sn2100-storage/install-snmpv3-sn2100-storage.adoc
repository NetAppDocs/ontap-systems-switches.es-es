...
summary: Esta versión incluye soporte para SNMPv3 para la monitorización de registros. 
---
= Configurar SNMPv3 para la recopilación de registros del switch
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Siga este procedimiento para configurar SNMPv3, que admite la recopilación de registros de conmutadores y la supervisión del estado del conmutador (SHM).

.Acerca de esta tarea
Los siguientes comandos configuran un nombre de usuario SNMPv3 en los switches NVIDIA SN2100:
...
El siguiente comando establece el nombre de usuario SNMPv3 con SHM:
...
----
====
. Configure SHM para que realice la monitorización con el nuevo usuario SNMPv3:
+
...
----
====
. Verifique que el número de serie que se consultará con el usuario SNMPv3 recién creado sea el mismo que se detalla en el paso anterior una vez que haya finalizado el período de sondeo SHM.
+
