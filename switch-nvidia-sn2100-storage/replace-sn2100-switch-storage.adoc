...
summary: La sustitución de un switch de almacenamiento NVIDIA SN2100 defectuoso es un procedimiento sin interrupciones. 
---
...
El link:http://hwu.netapp.com["Hardware Universe"^] proporciona todos los detalles de los puertos compatibles y sus configuraciones.
